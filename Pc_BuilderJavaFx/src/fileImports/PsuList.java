...
public class PsuList {
	...
	public static List<PcComponent> readPsuFromFile() {

		boolean firstLineRead = false;

		List<PcComponent> psuList = new ArrayList<>();

		try (BufferedReader br = new BufferedReader(new FileReader("psu.csv"))) {
			String line;
			...
			while ((line = br.readLine()) != null) {
				...
				PcComponent newPsu = new PcComponent(values[0], new BigDecimal(values[2]), Integer.parseInt(values[3]),
