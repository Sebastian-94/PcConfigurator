...
public class RamList {
	...
	public static List<PcComponent> readRamFromFile() {

		boolean firstLineRead = false;

		List<PcComponent> ramList = new ArrayList<>();

		try (BufferedReader br = new BufferedReader(new FileReader("ram.csv"))) {
			String line;
			...
			while ((line = br.readLine()) != null) {
				...
				PcComponent newRam = new PcComponent(values[0], new BigDecimal(values[2]), Integer.parseInt(values[3]),
