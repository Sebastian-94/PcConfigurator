...
public class GpuList {
	...
	public static List<PcComponent> readGpuFromFile() {

		boolean firstLineRead = false;

		List<PcComponent> gpuList = new ArrayList<>();

		try (BufferedReader br = new BufferedReader(new FileReader("gpu.csv"))) {
			String line;
			...
			while ((line = br.readLine()) != null) {
				...
				PcComponent newGpu = new PcComponent(values[0], new BigDecimal(values[2]), Integer.parseInt(values[3]),
